...
# 배열은 설정된 행과 열의 개수로만 저장공간이 제공
arr

# 2차원 배열: 행과 열에 이름을 설정
names = list(c("하츄핑", "말랑핑", "아자핑"), c("수학", "영어"))
...
# ===================
# 행렬(matrix)
# 행의 개수만 설정하면 열의 개수는 자동으로 저장할 데이터만큼 설정
...
x = 1:6
names = list(c("하츄핑", "아자핑"), c("수학", "영어", "국어"))
...
# 리스트 요소 추가
lst1.gender = list(성별 = "여")
lst1 = append(lst, lst.gender, after = 1)
lst1

lst2 = list(성명 = "팜틴", 성별 = "여", 나이 = 20, 성적 = c(90, 95))
...
# =====================
# 데이터프레임 2차원 형태의 테이블 구조에 데이터를 저장
